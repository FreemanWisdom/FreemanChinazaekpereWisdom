  ...
  return (
    <section className="min-h-[80vh] flex flex-col items-center justify-center text-center px-6">
      <div className="max-w-4xl animate-in fade-in slide-in-from-bottom-10 duration-1000">
        ...
        <h1 className="text-5xl md:text-8xl font-black mb-6 tracking-tight text-gray-900 dark:text-white leading-[1.1]">
          I'm <span className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">{profile.firstName}</span>.
        </h1>
