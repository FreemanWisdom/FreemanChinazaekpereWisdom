...
export default function Loader({ dark, isVisible }) {
  ...
  return (
    <div
      className={`fixed inset-0 z-[9999] flex flex-col items-center justify-center transition-all duration-500 ${dark
        ...
        {dark ? (
          ...
          <div className="absolute inset-0 opacity-20">
            {[...Array(3)].map((_, i) => (
              <div
                key={i}
                className="absolute bg-white rounded-full blur-xl animate-cloud-drift"
                style={{
                  width: `${200 + i * 100}px`,
                  height: `${100 + i * 50}px`,
                  top: `${20 + i * 20}%`,
      ...
      <div className="relative w-32 h-32 flex items-center justify-center">
        {dark ? (
          ...
          <div className="relative w-full h-full flex items-center justify-center">
            <div className="absolute w-24 h-24 bg-yellow-400 rounded-full shadow-[0_0_50px_rgba(250,204,21,0.6)] animate-sun-pulse" />
            <div className="absolute w-32 h-32 border-4 border-yellow-200/50 border-dashed rounded-full animate-slow-rotate animate-sun-pulse" style={{ animationDelay: '0.5s' }} />
          </div>
        )}
      </div>
